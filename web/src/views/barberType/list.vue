<template>
    <div>
        <el-breadcrumb>
            ...
            <el-breadcrumb-item>理发师类型列表</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card>
            <el-row>
            ...
            <el-row style="margin-top: 5px">
                <el-table :data="typeList"  border>
                    ...
                    <el-table-column prop="barberTypeName" width="300px"  label="理发师类型"></el-table-column>
...
<!--                            <el-button slot="reference">删除</el-button>-->
        ...
        <el-dialog style="text-align: center" title="新增/修改 信息" :visible.sync="dialogForm" width="500px">
            <el-form :model="barberType" :rules="rules" ref="barberType">
                <el-form-item label="理发类型昵称" label-width="120px" prop="barberTypeName">
                    <el-input v-model="barberType.barberTypeName"></el-input>
                </el-form-item>
                <el-form-item label="人员" label-width="120px">
                    <el-input v-model="barberType.count" disabled></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer" style="text-align: center">
                <el-button @click="dialogForm = false">取 消</el-button>
                <el-button type="primary" @click="updateUser(barberType)">确 定</el-button>
            </div>
        </el-dialog>
...
<script>
    export default {
        ...
        methods:{
            ...
            updateUser(e){
                this.$refs.barberType.validate((valid) => {
                    if (valid) {
                        this.$axios.post('/api/barberType/save',e).then((res)=>{
                            // console.log(res)
            ...
            async  del(e){
                ...
                if (e.count!=0){
                    ...
                    // 发起删除用户信息的数据请求
                    const {data: res} = await this.$axios.delete('/api/barberType/delete/' + e.barberTypeId)
                    if (res.success!==true) {
